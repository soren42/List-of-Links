...
<body>
                    ...
                    <div class="editor-panel">
                        <div class="editor-header">
                            ...
                            <div class="editor-header-actions">
                                <button id="btn-import" class="btn btn-ghost"><i class="fa-solid fa-file-import"></i> Import from Linktree</button>
    ...
    <!-- ─── Import from Linktree Modal ──────────────────── -->
    <div id="import-modal" class="modal-overlay">
        <div class="modal">
            <div class="modal-header">
                <h3 id="import-modal-title">Import from Linktree</h3>
                <button class="modal-close" id="import-modal-close">&times;</button>
            </div>
            <div class="modal-body">
                <!-- Step 1: URL Input -->
                <div id="import-step-url" class="import-step active">
                    <p class="modal-desc">Enter a Linktree profile URL to import links, avatar, bio, and theme settings.</p>
                    <div class="form-group">
                        <label for="import-url">Linktree URL</label>
                        <input type="text" id="import-url" placeholder="https://linktr.ee/username  or  @username">
                    </div>
                    <button id="import-fetch-btn" class="btn btn-primary btn-full">Fetch Profile</button>
                    <div id="import-url-error" class="auth-error"></div>
                </div>

                <!-- Step 2: Loading -->
                <div id="import-step-loading" class="import-step">
                    <div class="import-loading">
                        <div class="spinner"></div>
                        <p>Fetching Linktree profile&hellip;</p>
                    </div>
                </div>

                <!-- Step 3: Merge / Conflict Resolution -->
                <div id="import-step-merge" class="import-step">
                    <p class="modal-desc">Review the imported data and resolve any conflicts with your current page.</p>
                    <div id="import-merge-content">
                        <!-- Generated by JavaScript -->
                    </div>
                    <div class="modal-actions">
                        <button id="import-back-btn" class="btn btn-ghost">&larr; Back</button>
                        <button id="import-apply-btn" class="btn btn-primary">Apply Import</button>
                    </div>
                </div>
            </div>
        </div>
